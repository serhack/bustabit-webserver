...
module.exports = {
  ...
  "MONERO_HOST": process.env.BITCOIND_HOST,
  "MONERO_PORT": process.env.BITCOIND_PORT || 8332,
  "MONERO_USER": process.env.BITCOIND_USER,
  "MONERO_PASS": process.env.BITCOIND_PASS,
